...
registerAdapter(ChartType.CalendarHeatmap, {
  validate: isCalendarHeatmapData,
  resolve: (data, options, ctx) => ({
    option: resolveCalendarHeatmapOptions(
      data as CalendarHeatmapData,
      options as CalendarHeatmapChartOptions,
      ctx,
    ),
  }),
});
