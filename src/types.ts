...
/**
 * Bar-chart-specific options. Lives at `ChartOptions.bar`.
 ...
 * Each frame is a regular {@link XYData} whose `categories` (racer names)
...
export interface ChartOptions {
  ...
  /**
   * Bar-chart-specific options (sizing + per-bar coloring). Applies to all bar
   * variants. See {@link BarOptions}.
   */
  bar?: BarOptions;
